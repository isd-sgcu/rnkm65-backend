...
func (r *RepositoryMock) FindOne(id string, result *group.Group) error {
...
func (r *RepositoryMock) FindByToken(token string, result *group.Group) error {
...
func (r *RepositoryMock) Update(id string, result *group.Group) error {
	args := r.Called(id, result)
